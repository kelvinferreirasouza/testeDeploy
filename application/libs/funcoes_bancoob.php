...
//Guarda inicial
?><img src=<?= URL . "public/img/p.png" ?> width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?= URL . "public/img/p.png" ?> width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
...
?>
    src=<?= URL . "public/img/p.png" ?> width=<?php echo $f1?> height=<?php echo $altura?> border=0><img 
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
// Draw guarda final
?>
src=<?= URL . "public/img/p.png" ?> width=<?php echo $largo?> height=<?php echo $altura?> border=0><img 
src=imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=<?= URL . "public/img/p.png" ?> width=<?php echo 1?> height=<?php echo $altura?> border=0> 
  <?php
} //Fim da função
